...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Элемент " + value.toString() + " вставлен в " + index + "\n"
            mainText.text = viewModel.logText
        }
        ...
        pushfront.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Вставка в начало: " + value.toString() + "\n"
            mainText.text = viewModel.logText
        }
        ...
        pushend.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Вставка в конец: " + value.toString() + "\n"
            mainText.text = viewModel.logText
        }
        ...
        search.setOnClickListener {
            ...
            val index = Integer.parseInt(Index.text.toString())
            Index.setText("")
            viewModel.logText = viewModel.logText + "Индекс " + index + ": " + viewModel.list.find(index) + "\n"
            mainText.text = viewModel.logText
        }
        ...
        delete.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Индекс: " + index + " удален" + "\n"
            mainText.text =  viewModel.logText
        ...
        sort.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Список отсортирован!" + "\n"
            mainText.text =  viewModel.logText
            scroll.fullScroll(View.FOCUS_DOWN)
        }
        ...
        clear.setOnClickListener {
            ...
            viewModel.logText = viewModel.logText + "Список очищен!"+ "\n"
            mainText.text =  viewModel.logText
            scroll.fullScroll(View.FOCUS_DOWN)
        }
        ...
        show.setOnClickListener {
            viewModel.logText = viewModel.logText + "Список\n" + viewModel.list.toString()+ "\n"
            mainText.text =  viewModel.logText
            scroll.fullScroll(View.FOCUS_DOWN)
        }
        ...
        save.setOnClickListener {
            Serialization.saveToFile(viewModel.list,"file.txt", spinner.selectedItem.toString())
            viewModel.logText = viewModel.logText + "Список сохранен!\n"
            mainText.text =  viewModel.logText
            scroll.fullScroll(View.FOCUS_DOWN)
        }
        ...
        load.setOnClickListener {
            viewModel.list = Serialization.loadFile("file.txt")
            viewModel.logText = viewModel.logText + "Список загружен!\n"
            mainText.text =  viewModel.logText
            scroll.fullScroll(View.FOCUS_DOWN)
        }
    }
